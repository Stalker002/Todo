...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->panel1->Size = System::Drawing::Size(382, 1150);
			...
			this->pictureBox6->Click += gcnew System::EventHandler(this, &done::pictureBox6_Click);
			// 
			// pictureBox5
			// 
			this->pictureBox5->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(255)), static_cast<System::Int32>(static_cast<System::Byte>(239)),
			...
			this->pictureBox3->Click += gcnew System::EventHandler(this, &done::pictureBox3_Click);
			// 
			// add_pictureBox
			// 
			...
			this->add_pictureBox->Location = System::Drawing::Point(18, 970);
			...
			this->add_pictureBox->Click += gcnew System::EventHandler(this, &done::add_pictureBox_Click);
			// 
			// add_label
			// 
			...
			this->add_label->Location = System::Drawing::Point(86, 980);
			...
			this->add_label->Click += gcnew System::EventHandler(this, &done::add_label_Click);
			// 
			// label5
			// 
			...
			this->label5->Click += gcnew System::EventHandler(this, &done::label5_Click);
			// 
			// label4
			// 
			this->label4->AutoSize = true;
			this->label4->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(255)), static_cast<System::Int32>(static_cast<System::Byte>(239)),
				static_cast<System::Int32>(static_cast<System::Byte>(229)));
			...
			this->label2->Click += gcnew System::EventHandler(this, &done::label2_Click);
			// 
			// label1
			// 
			...
			this->label1->Click += gcnew System::EventHandler(this, &done::label1_Click);
			// 
			// pictureBox1
			// 
			...
			this->pictureBox1->Click += gcnew System::EventHandler(this, &done::pictureBox1_Click);
			// 
			// panel3
			// 
			this->panel3->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(255)), static_cast<System::Int32>(static_cast<System::Byte>(239)),
				static_cast<System::Int32>(static_cast<System::Byte>(229)));
			this->panel3->Location = System::Drawing::Point(18, 415);
			...
			this->panel2->Size = System::Drawing::Size(1424, 1150);
			...
			this->pictureBox7->Location = System::Drawing::Point(1282, 0);
			this->pictureBox7->Name = L"pictureBox7";
			this->pictureBox7->Size = System::Drawing::Size(48, 48);
			this->pictureBox7->SizeMode = System::Windows::Forms::PictureBoxSizeMode::AutoSize;
			this->pictureBox7->TabIndex = 2;
			this->pictureBox7->TabStop = false;
			this->pictureBox7->Click += gcnew System::EventHandler(this, &done::pictureBox7_Click);
			// 
			// label7
			// 
			...
			this->label7->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(209)), static_cast<System::Int32>(static_cast<System::Byte>(69)),
				static_cast<System::Int32>(static_cast<System::Byte>(59)));
			this->label7->Location = System::Drawing::Point(486, 55);
			this->label7->Name = L"label7";
			this->label7->Size = System::Drawing::Size(423, 46);
			this->label7->TabIndex = 2;
			this->label7->Text = L"Выполненные задачи";
			// 
			// dataGridView1
			// 
			...
			this->dataGridView1->Size = System::Drawing::Size(1170, 876);
			this->dataGridView1->TabIndex = 1;
			this->dataGridView1->CellFormatting += gcnew System::Windows::Forms::DataGridViewCellFormattingEventHandler(this, &done::dataGridView1_CellFormatting);
			this->dataGridView1->CellMouseDoubleClick += gcnew System::Windows::Forms::DataGridViewCellMouseEventHandler(this, &done::dataGridView1_CellMouseDoubleClick);
			// 
			// done
			// 
			...
			this->ClientSize = System::Drawing::Size(1785, 1150);
			...
			this->Text = L"Поехали!";
			this->Activated += gcnew System::EventHandler(this, &done::done_Activated);
			this->KeyDown += gcnew System::Windows::Forms::KeyEventHandler(this, &done::done_KeyDown);
...
#pragma endregion
	...
	private: System::Void done_Activated(System::Object^ sender, System::EventArgs^ e) {
		...
		try {
			...
			if (sqlconn->State == ConnectionState::Open) {
				...
				if (userId != -1) {
					...
					String^ sqlEventsQuery = "SELECT status AS Статус, Title AS Задача, Type AS Тип, StartDate AS Дата, Color FROM Events WHERE status = 'Выполнена' AND Id_user = @userId ORDER BY StartDate ASC;";
	...
	private: System::Void done_KeyDown(System::Object^ sender, System::Windows::Forms::KeyEventArgs^ e) {
